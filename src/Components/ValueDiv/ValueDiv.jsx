...
function ValueDiv() {
  return (
    <div className="mb-[4rem] mt-[6rem]">
      <h1 className="text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold w-[80%] lg:w-[400px] block">
        The value that holds us true and account
      </h1>
      <div className="grid gap-5 lg:gap-[10rem] md:grid-cols-3 items-center">
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
          <div className="flex items-center gap-3">
            <div className="imgDiv p-[4px] rounded-[.8rem] bg-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
              <img src="./avatar.png" alt="testimonials" className="w-[70%]" />
            </div>
          ...
          <p className="text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold">
            Things being made beautiful simply are at the heart of everything we
            do.
          </p>
        </div>
