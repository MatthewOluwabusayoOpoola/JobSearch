...
function FooterDiv() {
  return (
    <div className="footer p-[3rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid lg:grid-cols-5 m-auto items-center justify-center">
      <div>
      ...
      <a
        href="mailto:messagematthewopoola@gmail.com"
        className="text-[10px] text-white"
      >
        messagematthewopoola@gmail.com
      </a>
    </div>
  );
}
